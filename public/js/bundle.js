...
var stripe = Stripe("pk_test_51LlW3PSDmCCfV1vFO9PfmtfqGBsnnNECyoAPcdfdskiTxhcX8v7BKbwsQ7OcedfeW5WavvL7rZveflIT2bIZNB0Y00Hn6Tazbe");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/create-stripe-session/".concat(tourId));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            (0, _alert.showAlert)('success', "you logged in successfully.");
            setTimeout(function () {
              location.assign('/');
            }, 1200);
            _context.next = 11;
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateData.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res) {
              (0, _alert.showAlert)("success", "Successfully registed your account");
              setTimeout(function () {
...
var saveForm = document.querySelector(".form-user-data");
var changePasswordForm = document.querySelector(".form-user-settings");
var bookingTour = document.getElementById('book-tour');
...
if (registerForm) {
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.register)(name, email, password, passwordConfirm);
  });
}
...
if (changePasswordForm) {
  changePasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateData.updatePassword)(currentPassword, password, passwordConfirm);
  });
}
